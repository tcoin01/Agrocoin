...
// agrocoin includes.
#include <..\src\script\agrocoinconsensus.h>
...
int main()
{
    std::cout << "agrocoinconsensus version: " << agrocoinconsensus_version() << std::endl;
    ...
    auto op0Result = agrocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, agrocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
