...
class TestShell:
    """Wrapper Class for AgroCoinTestFramework.

    The TestShell class extends the AgroCoinTestFramework
    ...
    class __TestShell(AgroCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AgroCoinTestFramework child class.
            self.num_nodes = 1
