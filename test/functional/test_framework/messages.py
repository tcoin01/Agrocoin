...
"""AgroCoin test framework primitive and message structures
...
COIN = 100000000  # 1 agro in satoshis
MAX_MONEY = 50050000 * COIN
...
# Objects that map to agrocoind objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/agrocoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in agrocoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
    ...
    def is_valid(self):
        ...
        for tout in self.vout:
            if tout.nValue < 0 or tout.nValue > 50050000 * COIN:
                return False
        return True
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in agrocoind indicates these should be deserialized as blocks
