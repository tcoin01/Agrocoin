...
class P2PPermissionsTests(AgroCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].agrocoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].agrocoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
