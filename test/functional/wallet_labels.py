...
class WalletLabelsTest(AgroCoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 AgroCoins
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid AgroCoin address or script",
