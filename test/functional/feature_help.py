...
"""Verify that starting agrocoin with -h works as expected."""

from test_framework.test_framework import AgroCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(AgroCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start agrocoin with -h for help text")
        ...
        self.log.info("Start agrocoin with -version for version information")
        ...
        self.log.info("Start agrocoind with -fakearg to make sure it does not start")
