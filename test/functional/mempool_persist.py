...
By default, agrocoind will dump mempool on shutdown and
...
class MempoolPersistTest(AgroCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent agrocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
