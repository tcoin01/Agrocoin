...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AgroCoinTestFramework
    pass


class ExampleTest(AgroCoinTestFramework):
    # Each functional test is a subclass of the AgroCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AgroCoinTestFramework class so other tests can use it."""
