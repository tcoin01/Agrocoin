...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the agrocoin repository."
  exit 1
fi
...
# See https://github.com/agrocoin/agrocoin/issues/16064
...
echo 'When compiling agrocoind, run `./configure` in the following way:'
echo
