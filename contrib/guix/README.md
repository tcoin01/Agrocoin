# Bootstrappable AgroCoin Core Builds

This directory contains the files necessary to perform bootstrappable AgroCoin
Core builds.
...
- 24GB of free disk space on the partition that the AgroCoin Core git repository
  resides in
...
For a AgroCoin Core depends development environment, simply invoke
...
From the top of a clean AgroCoin Core repository:
...
To use dongcarl's substitute server for AgroCoin Core builds after having
