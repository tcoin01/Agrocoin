...
First, in terms of structure, there is no particular concept of "AgroCoin Core
...
Before you start contributing, familiarize yourself with the AgroCoin Core build
system and tests. Refer to the documentation in the repository on how to build
AgroCoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/agrocoin/agrocoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/agrocoin/agrocoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[AgroCoin Core PR Review Club](https://agrocoincore.reviews/) meeting.
...
Most communication about AgroCoin Core development happens on IRC, in the
`#agrocoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/agrocoin-core-dev/](http://www.erisian.com.au/agrocoin-core-dev/)
and [http://gnusha.org/agrocoin-core-dev/](http://gnusha.org/agrocoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/agrocoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/agrocoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/agrocoin/agrocoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to agrocoin-qt
...
fork of AgroCoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/agrocoin/agrocoin/blob/master/doc/translation_process.md)
...
https://github.com/agrocoin/agrocoin/pull/16189).

Also see the [backport.py script](
https://github.com/agrocoin-core/agrocoin-maintainer-tools#backport).
