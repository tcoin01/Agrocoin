...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/AgroCoin
else
  DOCKER_EXEC echo \> \$HOME/.agrocoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/agrocoin/agrocoin/pull/18288#discussion_r433189350 for
  # details.
