 ...
 */
#ifndef AGROCOIN_UTIL_SYSTEM_H
#define AGROCOIN_UTIL_SYSTEM_H
...
extern const char * const AGROCOIN_CONF_FILENAME;
extern const char * const AGROCOIN_SETTINGS_FILENAME;
