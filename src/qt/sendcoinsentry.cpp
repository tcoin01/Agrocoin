    ...
    platformStyle(_platformStyle)
{
    ...
    // normal agrocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying agrocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &AgroCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
