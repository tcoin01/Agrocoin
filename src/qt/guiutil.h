...
#ifndef AGROCOIN_QT_GUIUTIL_H
#define AGROCOIN_QT_GUIUTIL_H
...
namespace GUIUtil
{
    ...
    // Parse "agrocoin:" URI into recipient object, return true on successful parsing
