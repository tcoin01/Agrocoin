    ...
    mapper(nullptr)
{
    ...
    ui->agrocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->agrocoinAtStartup);
    ...
    ui->agrocoinAtStartup->setToolTip(ui->agrocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->agrocoinAtStartup->setText(ui->agrocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openAgroCoinConfButton->setToolTip(ui->openAgroCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AgroCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->agrocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAgroCoinConfButton_clicked()
{
