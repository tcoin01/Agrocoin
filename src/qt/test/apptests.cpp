...
//! Entry point for AgroCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AgroCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AgroCoinGUI tests.
void AppTests::guiTests(AgroCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AgroCoinGUI::consoleShown, this, &AppTests::consoleTests);
