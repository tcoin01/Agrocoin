...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, AgroCoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &AgroCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &AgroCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &AgroCoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &AgroCoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &AgroCoinGUI::updateWalletStatus);
    connect(gui, &AgroCoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
