...
static void SetupAgroCoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " agrocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  agrocoin-tx [options] <hex-tx> [commands]  Update hex-encoded agrocoin transaction\n" +
            "or:     agrocoin-tx [options] -create [commands]   Create hex-encoded agrocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded agrocoin transaction
