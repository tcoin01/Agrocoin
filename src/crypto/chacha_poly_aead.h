...
#ifndef AGROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define AGROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@agrocoin.
 *
 ...
 *
 * The chacha20-poly1305@agrocoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@agrocoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@agrocoin are relatively fast in
...
#endif // AGROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
