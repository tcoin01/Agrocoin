...
#ifndef AGROCOIN_TEST_SCRIPTNUM10_H
#define AGROCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AgroCoin Core 0.10.0, for cross-comparison.
 */
public:
