...
{
    BOOST_CHECK(TestSplitHost("www.agrocoincore.org", "www.agrocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.agrocoincore.org]", "www.agrocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.agrocoincore.org:80", "www.agrocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.agrocoincore.org]:80", "www.agrocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:37564", "127.0.0.1", 37564));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:37564", "127.0.0.1", 37564));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:37564", "::ffff:127.0.0.1", 37564));
    BOOST_CHECK(TestSplitHost("[::]:37564", "::", 37564));
    BOOST_CHECK(TestSplitHost("::37564", "::37564", -1));
    BOOST_CHECK(TestSplitHost(":37564", "", 37564));
    BOOST_CHECK(TestSplitHost("[]:37564", "", 37564));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:37564", "127.0.0.1:37564"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:37564", "[::]:37564"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
