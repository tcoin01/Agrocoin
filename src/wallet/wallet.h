...
#ifndef AGROCOIN_WALLET_WALLET_H
#define AGROCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this agrocoin node, and set to 0 for transactions that were created
...
#endif // AGROCOIN_WALLET_WALLET_H
