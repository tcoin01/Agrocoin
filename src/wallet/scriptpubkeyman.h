...
#ifndef AGROCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define AGROCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The AgroCoin Core wallet was originally a collection of unrelated private
...
#endif // AGROCOIN_WALLET_SCRIPTPUBKEYMAN_H
