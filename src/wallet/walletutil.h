...
#ifndef AGROCOIN_WALLET_WALLETUTIL_H
#define AGROCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! agrocoin from opening the wallet, thinking it was newly created, and
...
#endif // AGROCOIN_WALLET_WALLETUTIL_H
