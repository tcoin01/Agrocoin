...
#ifndef AGROCOIN_COMPAT_ASSUMPTIONS_H
#define AGROCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "AgroCoin cannot be compiled without assertions."
#endif
...
#endif // AGROCOIN_COMPAT_ASSUMPTIONS_H
