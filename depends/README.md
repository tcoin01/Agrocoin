...
**AgroCoin Core's configure script by default will ignore the depends output.** In
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_agrocoin` executable (see https://github.com/agrocoin/agrocoin/pull/13543),
